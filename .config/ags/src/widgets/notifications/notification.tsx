              ...
              <button
                ...
                onClicked={() => {
                  if (id.includes('action:')) {
                    // https://github.com/Jas-SinghFSU/HyprPanel/blob/efdcb7d53bd53b18b707e13363a48646e4be6d61/src/components/notifications/Actions.tsx#L17
                    execAsync(`${id.replace('action:', '')}`).catch(print);
                    n.dismiss();
                    return;
                  }
                  n.invoke(id);
